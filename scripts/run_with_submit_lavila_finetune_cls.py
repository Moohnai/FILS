...
import submitit
import scripts.main_lavila_finetune_cls as main_lavila_finetune_cls


def parse_args():
    parser = main_lavila_finetune_cls.get_args_parser()
    parser = argparse.ArgumentParser("Submitit for lavila finetune cls", parents=[parser])
...
class Trainer(object):
    ...
    def __call__(self):
        ...
        main_lavila_finetune_cls.main(self.args)
