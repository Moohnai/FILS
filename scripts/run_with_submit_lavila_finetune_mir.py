...
import submitit
import scripts.main_lavila_finetune_mir as main_lavila_finetune_mir


def parse_args():
    parser = main_lavila_finetune_mir.get_args_parser()
    parser = argparse.ArgumentParser("Submitit for lavila finetune mir", parents=[parser])
...
class Trainer(object):
    ...
    def __call__(self):
        ...
        main_lavila_finetune_mir.main(self.args)
